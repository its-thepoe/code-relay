...
// Validate ../../app/api/jobs/[id]/artifact/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/jobs/[id]/artifact">> = Specific
  const handler = {} as typeof import("../../app/api/jobs/[id]/artifact/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
